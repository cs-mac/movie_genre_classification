...
def read_files(genres):
    ...
    for genre in genres:
        ...
        for file in filenames:
            ...
            w_list = [tok for tok in dialogue_one_list]
...
class FeaturesExtractor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, subs):
        ...
        #features['text'] = [' '.join(to_list(item[1])) for item in subs] #cleaner looking, but same functionality
...
def main():
    ...
    try:
        ...
        print("Not enough information to get high information words, please try again with more files.", file=sys.stderr)
        X_high_info = X
    ...
    X = [(str(w),str(w_high), wpm, dpm, dd, d2v) for w, w_high, wpm, dpm, dd, d2v in zip(X, X_high_info, X_wpm, X_dpm, X_dd, X_d2v)]
        ...
        ('union', FeatureUnion(
            transformer_list=[
                ...
                ('text', Pipeline([
                    ...
                    ('tfidf', TfidfVectorizer(sublinear_tf=True, binary=True, ngram_range=(1,1), stop_words=union_stopword_set)),
                ])),
                ...
                ('pos', Pipeline([
                    ...
                    ('words', TfidfVectorizer(sublinear_tf=True, binary=True, ngram_range=(1,1)))
                ])),
